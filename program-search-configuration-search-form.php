...
<section class="su-listing">
    <div id="searchoptionsGeneric" role="search" class="su-listing--form-wrapper bg--dark global-padding--8x" data-t4-ajax-group="courseSearch">
        ...
        <div class="grid-container">
            <h2 class="h3">Find a Program</h2>
        </div>

        <form>
            <div class="cell medium-6 large-4">
                <label for="keywords">Search</label>
                <input type="text" name="keywords" id="keywords" placeholder="Search All Programs&hellip;" value="<?php echo !empty($query['keywords']) ? $query['keywords'] : ''  ?>">
            </div>
            <div class="cell medium-6 large-4">
                <fieldset>
                    <?php
                    $element = 'learningFormat';
                    ...
                    ?>
                    <legend>Filter by Learning Format</legend>
            ...
            <div class="cell medium-6 large-4">
                ...
                $search = $genericFacet->displayFacet();
                ?>
                <label for="<?php echo $element; ?>" class="label-text">Filter by Program Level</label>
            ...
            <div class="cell medium-6 large-4">
                ...
                $search = $genericFacet->displayFacet();
                ?>
                <label for="area" class="label-text">Filter by Area of Study</label>
                <select id="<?php echo $element; ?>" name="<?php echo $element; ?>" data-cookie="T4_persona">
            ...
            <div class="cell medium-6 large-4">
                ...
                $search = $genericFacet->displayFacet();
                ?>
                <label for="area" class="label-text">Filter by School or College</label>
                <select id="<?php echo $element; ?>" name="<?php echo $element; ?>" data-cookie="T4_persona">
